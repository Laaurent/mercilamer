    ...
    <div class="wrapper">
        <div class="container">
            <div class="content_card">
                ...
                <div class="flex">
                    <div class="assoc">{{ article.association.name }}</div>
                    <div class="support">
                        <p>{{ article.support.name }}</p>
                        <img
                            :src="
                                '/images/icons/' + article.support.name + '.svg'
                            "
                            alt="Image support"
                        />
                    </div>
    ...
    .container {
        .content_card {
            ...
            .support {
                ...
                color: #949494;
                img {
                    filter: invert(64%) sepia(18%) saturate(16%)
                        hue-rotate(23deg) brightness(89%) contrast(89%);
                    width: 24px;
                    margin-bottom: 2px;
                }
            }
